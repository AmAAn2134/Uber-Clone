...
const Riding = () => {
  return (
    <div className="h-screen bg-white flex flex-col justify-around ">
            ...
            <div className="flex items-center gap-5 border-b-2 pb-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 ">
                  34 f Cha hacha ccolony come here if u wanna order some coffee
                </p>
              </div>
            </div>
      ...
      <button className="mt-5 rounded-lg bg-green-600 w-full font-semibold text-white p-3">Make a payment</button>
          </div>
        </div>{" "}
      </div>
    </div>
